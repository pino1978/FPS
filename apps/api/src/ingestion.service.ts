          ...
          if (!latest) {
            await this.db.teamSnapshot.create({
              data: {
                ...
                homePoints: standing.home?.points,
                homeGoalsFor: standing.home?.goalsFor,
                homeGoalsAgainst: standing.home?.goalsAgainst,
                awayPlayed: standing.away?.played,
                awayPoints: standing.away?.points,
                awayGoalsFor: standing.away?.goalsFor,
                awayGoalsAgainst: standing.away?.goalsAgainst,
                source: 'football-data.org',
              },
            });
          }
